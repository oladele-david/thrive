<?php
   ...
   $bank = new Bank();
    ...
    if(isset($_POST['updatePassword'])) {
        ...
        $updatePassword = $account->updatePassword($userInSession, $password);
        ob_clean();
        echo $updatePassword;              
        exit;
    }
    ...
    if (isset($_POST['updateProfile'])) {
        ...
        $updateAccount = $account->updateAccount($userInSession, $reeveAccountNo, $lastName, $firstName, $otherName, $motherMaidenName, $bvn, $nin, $gender, $dateOfBirth, $address, $city, $stateId, $countryId, $phoneNo, $emailId, $defaultBankId, $bankAccountNo, $bankAccountName);
        ob_clean();
        echo $updateAccount;              
        exit;
